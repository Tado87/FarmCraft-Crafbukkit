...
/*     */   protected void loadJarURLs() throws Exception {
   ...
   /* 182 */         path = new URL("http://lepeltier.info/farmcraft/maj/");
   /*     */       }
   /*     */ 
   /* 185 */       System.out.println(path + nextToken.replaceAll("minecraft.jar", "farmcraft.jar"));
   /* 186 */       if (nextToken.indexOf("craft.jar") >= 0) {
   /* 187 */         this.urlList[i] = new URL(path, nextToken.replaceAll("minecraft.jar", "farmcraft.jar"));
   /*     */       }
   /*     */       else {
...
/*     */         }
/*     */ 
/* 254 */         boolean updatefarmcraft = false;
/*     */         try {
/* 256 */           String version_farmcraft = "";
/* 257 */           URL url_version = new URL("http://lepeltier.info/farmcraft/maj/version_farmcraft.txt");
/*     */           try {
/* 259 */             BufferedReader in = new BufferedReader(new InputStreamReader(url_version.openStream()));
/* 260 */             version_farmcraft = in.readLine();
/*     */           }
/*     */           catch (Exception e) {
/* 263 */             System.err.println(e);
/*     */           }
/* 265 */           File current_version_farmcraft = new File(dir, "version_farmcraft.txt");
/*     */ 
/* 267 */           if (!current_version_farmcraft.exists()) {
/* 268 */             updatefarmcraft = true;
/*     */             try {
/* 270 */               BufferedWriter bw = new BufferedWriter(new FileWriter(current_version_farmcraft));
/* 271 */               bw.append(version_farmcraft);
/* 272 */               bw.close();
/*     */             } catch (IOException e) {
...
/*     */           {
/*     */             try {
/* 280 */               Scanner scanner = new Scanner(current_version_farmcraft);
/* 281 */               while (scanner.hasNextLine()) {
/* 282 */                 String line = scanner.nextLine().trim();
/* 283 */                 if (!version_farmcraft.equals(line)) {
/* 284 */                   updatefarmcraft = true;
/*     */                   try {
/* 286 */                     BufferedWriter bw = new BufferedWriter(new FileWriter(current_version_farmcraft));
/* 287 */                     bw.append(version_farmcraft);
/* 288 */                     bw.close();
/*     */                   } catch (IOException e) {
...
/*     */         }
/*     */ 
/* 308 */         if ((!cacheAvailable) || (updatefarmcraft) || (forceUpdate))  {
